...
class ServiceService {
  ...
  Future<ServiceSubCategory> getSubcategoryById(int id) async {
    ...
    throw UnimplementedError(
      'Use getSubcategories() instead to fetch subcategories for a category',
    );
  }
}
